            ...
            <div class="col-lg-8">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('tracerstudy.kuesionare.create') }}" method="POST" class="form-material" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-line" placeholder="Masukan Title" name="C_QUESTIONS_TITLE" id="C_QUESTIONS_TITLE" value="" required> 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="C_QUESTIONS_QUESTION" rows="5" placeholder="Enter Question"></textarea>
                                </div>
                                <hr>
